...
#include "LiveLogReaderSR300.h"

LiveLogReaderSR300::LiveLogReaderSR300(std::string file, bool flipColors)
...
LiveLogReaderSR300::~LiveLogReaderSR300()
{
...
const std::string LiveLogReaderSR300::getFile()
{
    return Parse::get().baseDir().append("live");
}

int LiveLogReaderSR300::getNumFrames()
{
    return std::numeric_limits<int>::max();
}

bool LiveLogReaderSR300::hasMore()
{
    return true;
}

void LiveLogReaderSR300::setAuto(bool value)
{
