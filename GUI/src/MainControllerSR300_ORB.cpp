...
MainControllerSR300_ORB::~MainControllerSR300_ORB()
{
    if(eFusion)
    {
        delete eFusion;
...
void MainControllerSR300_ORB::loadCalibration(const std::string & filename)
{
...
void MainControllerSR300_ORB::launch()
{
    while(good)
    {
        if(eFusion)
...
void MainControllerSR300_ORB::run()
{
